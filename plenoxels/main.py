...
def load_data(model_type: str, data_downsample, data_dirs, truncation, validate_only: bool, render_only: bool, **kwargs):
    ...
    if model_type == "video":
        return video_trainer.load_data(
            ...
            render_only=render_only, truncation=truncation, **kwargs)
...
def main():
    ...
    if validate_only:
        trainer.validate(show_training_renders=True)
    elif render_only:
